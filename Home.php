...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="bodyFonst">
                        <form action="/loginform/Home.php" method="POST" id="fromNavbar">
    ...
    <div id="bodyFonst">
        ...
        <div id="main" class="mb-5">
            ...
            <form action="/loginform/Home.php" method="POST">
                <label for="BookName">Book Name:</label>
            ...
            <div id="rentedBooks">
                <h2>Rented Books:</h2>
                <?php
                $rented = "SELECT * FROM `library` WHERE `isRented` = 1";
                $rented = mysqli_query($con, $rented);

                while ($row = mysqli_fetch_assoc($rented)) {
                    echo "<p>Book Name: " . $row['book'] . " | Price: " . $row['price'] . "</p>";
                }
                ?>
            </div>
        </div>
        ...
        Array.from(Delete).forEach((element) => {
            ...
            element.addEventListener("click", (e) => {
                ...
                if (confirm("You Are Agree For Delete This Form!")) {
                    ...
                    window.location = `/loginform/Home.php?delete=${sno}`;
                } else {
                    console.log("Now");
                }
            });
    ...
    <script>
        // Rented = document.getElementsByClassName("Rent");
        // messages = document.getElementsByClassName("message");

        // Array.from(Rented).forEach((element) => {
        //     element.addEventListener("click", (e) => {
        //             tr = e.target.parentNode.parentNode;
        //             BookName = tr.getElementsByTagName("td")[1].innerHTML;
        //             price = tr.getElementsByTagName("td")[3].innerHTML;
        //             idno = e.target.id.substr(1);
        ...
        //             } else {
        //                 alert("Invalid input for months. Please enter a non-negative number.");
        //             }
        //         }
        //     });
        // });
    ...
    <!-- // <div class='card' style='width: 18rem; padding: 25px; margin-bottom: 20px;'>
                        //     <ul class='list-group list-group-flush'>
                        //         <h5>Book Name</h5>
                        //         <div class='mb-2' name='BookName' id='BookName'>${BookName}</div>
                        //         <h5>Price</h5>
                        //         <div class=' mb-2' name='price' id='PriceRent'>${price}</div>
                        //         <h5>Months</h5>
                        //         <div class='mb-2' name='months' id='MonthsRent'>${months}</div>
                        //         <button class='btn btn-success mt-4' onclick="saveToLocalStorage('${BookName}', ${price}, ${months})">Rented</button>
                        //     </ul> -->
